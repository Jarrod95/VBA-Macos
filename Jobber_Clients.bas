...
Dim retVal As Long
    ...
    Sheets(1).Copy
    ActiveWorkbook.SaveAs "C:\Users\info\OneDrive\1. M2M Administration\EXPORTED FROM SOFTWARE\Maps Data\Existing_Clients_" & _
    Format(Date, "dd-mm-yyyy") & ".xlsx"
    ActiveWorkbook.Close
    Sheets(2).Copy
    ActiveWorkbook.SaveAs "C:\Users\info\OneDrive\1. M2M Administration\EXPORTED FROM SOFTWARE\Maps Data\New_Clients_" & _
    Format(Date, "dd-mm-yyyy") & ".xlsx"
    ActiveWorkbook.Close
